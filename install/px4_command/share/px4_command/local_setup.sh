...
: ${AMENT_CURRENT_PREFIX:="/home/constantine/uav_payload_control/install/px4_command"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_command/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_command/environment/path.sh"
