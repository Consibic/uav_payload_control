...
(cl:defmethod cl:initialize-instance :after ((m <SinglePayloadAction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SinglePayloadAction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<SinglePayloadAction-request> is deprecated: use qt_ground_station-srv:SinglePayloadAction-request instead.")))

(cl:ensure-generic-function 'perform_action-val :lambda-list '(m))
(cl:defmethod perform_action-val ((m <SinglePayloadAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:perform_action-val is deprecated.  Use qt_ground_station-srv:perform_action instead.")
  (perform_action m))

(cl:ensure-generic-function 'action_type-val :lambda-list '(m))
(cl:defmethod action_type-val ((m <SinglePayloadAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:action_type-val is deprecated.  Use qt_ground_station-srv:action_type instead.")
  (action_type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SinglePayloadAction-request>)))
  ...
  "qt_ground_station/SinglePayloadActionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction-request)))
  "Returns string type for a service object of type 'SinglePayloadAction-request"
  "qt_ground_station/SinglePayloadActionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SinglePayloadAction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SinglePayloadAction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<SinglePayloadAction-response> is deprecated: use qt_ground_station-srv:SinglePayloadAction-response instead.")))

(cl:ensure-generic-function 'status_ok-val :lambda-list '(m))
(cl:defmethod status_ok-val ((m <SinglePayloadAction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:status_ok-val is deprecated.  Use qt_ground_station-srv:status_ok instead.")
  (status_ok m))
...
(cl:defmethod trajectory_type-val ((m <SinglePayloadAction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:trajectory_type-val is deprecated.  Use qt_ground_station-srv:trajectory_type instead.")
  (trajectory_type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SinglePayloadAction-response>)))
  ...
  "qt_ground_station/SinglePayloadActionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction-response)))
  "Returns string type for a service object of type 'SinglePayloadAction-response"
  "qt_ground_station/SinglePayloadActionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SinglePayloadAction)))
  ...
  "qt_ground_station/SinglePayloadAction")