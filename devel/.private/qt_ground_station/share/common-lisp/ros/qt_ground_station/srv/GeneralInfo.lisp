...
(cl:defmethod cl:initialize-instance :after ((m <GeneralInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneralInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<GeneralInfo-request> is deprecated: use qt_ground_station-srv:GeneralInfo-request instead.")))
...
(cl:defmethod TargetdroneID-val ((m <GeneralInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:TargetdroneID-val is deprecated.  Use qt_ground_station-srv:TargetdroneID instead.")
  (TargetdroneID m))

(cl:ensure-generic-function 'isMulti-val :lambda-list '(m))
(cl:defmethod isMulti-val ((m <GeneralInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:isMulti-val is deprecated.  Use qt_ground_station-srv:isMulti instead.")
  (isMulti m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneralInfo-request>)))
  ...
  "qt_ground_station/GeneralInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneralInfo-request)))
  "Returns string type for a service object of type 'GeneralInfo-request"
  "qt_ground_station/GeneralInfoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GeneralInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneralInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<GeneralInfo-response> is deprecated: use qt_ground_station-srv:GeneralInfo-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneralInfo-response>)))
  ...
  "qt_ground_station/GeneralInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneralInfo-response)))
  "Returns string type for a service object of type 'GeneralInfo-response"
  "qt_ground_station/GeneralInfoResponse")
