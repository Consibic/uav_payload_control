...
(cl:defmethod cl:initialize-instance :after ((m <SetHome-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHome-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<SetHome-request> is deprecated: use qt_ground_station-srv:SetHome-request instead.")))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <SetHome-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:longitude-val is deprecated.  Use qt_ground_station-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <SetHome-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:latitude-val is deprecated.  Use qt_ground_station-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <SetHome-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:altitude-val is deprecated.  Use qt_ground_station-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHome-request>)))
  ...
  "qt_ground_station/SetHomeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHome-request)))
  "Returns string type for a service object of type 'SetHome-request"
  "qt_ground_station/SetHomeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetHome-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetHome-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-srv:<SetHome-response> is deprecated: use qt_ground_station-srv:SetHome-response instead.")))

(cl:ensure-generic-function 'homeset_ok-val :lambda-list '(m))
(cl:defmethod homeset_ok-val ((m <SetHome-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-srv:homeset_ok-val is deprecated.  Use qt_ground_station-srv:homeset_ok instead.")
  (homeset_ok m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetHome-response>)))
  ...
  "qt_ground_station/SetHomeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetHome-response)))
  "Returns string type for a service object of type 'SetHome-response"
  "qt_ground_station/SetHomeResponse")
