...
(cl:defclass <Trajectory> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector qt_ground_station-msg:TrajectoryPoint)
   :initform (cl:make-array 0 :element-type 'qt_ground_station-msg:TrajectoryPoint :initial-element (cl:make-instance 'qt_ground_station-msg:TrajectoryPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-msg:<Trajectory> is deprecated: use qt_ground_station-msg:Trajectory instead.")))
...
(cl:defmethod points-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:points-val is deprecated.  Use qt_ground_station-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trajectory>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'qt_ground_station-msg:TrajectoryPoint))
