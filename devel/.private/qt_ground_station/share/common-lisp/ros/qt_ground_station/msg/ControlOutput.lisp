...
(cl:defmethod cl:initialize-instance :after ((m <ControlOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-msg:<ControlOutput> is deprecated: use qt_ground_station-msg:ControlOutput instead.")))
...
(cl:defmethod u_l-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:u_l-val is deprecated.  Use qt_ground_station-msg:u_l instead.")
  (u_l m))

(cl:ensure-generic-function 'u_d-val :lambda-list '(m))
(cl:defmethod u_d-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:u_d-val is deprecated.  Use qt_ground_station-msg:u_d instead.")
  (u_d m))

(cl:ensure-generic-function 'NE-val :lambda-list '(m))
(cl:defmethod NE-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:NE-val is deprecated.  Use qt_ground_station-msg:NE instead.")
  (NE m))

(cl:ensure-generic-function 'Thrust-val :lambda-list '(m))
(cl:defmethod Thrust-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:Thrust-val is deprecated.  Use qt_ground_station-msg:Thrust instead.")
  (Thrust m))

(cl:ensure-generic-function 'Throttle-val :lambda-list '(m))
(cl:defmethod Throttle-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:Throttle-val is deprecated.  Use qt_ground_station-msg:Throttle instead.")
  (Throttle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlOutput>)))
  ...
  "qt_ground_station/ControlOutput")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlOutput)))
  "Returns string type for a message object of type 'ControlOutput"
  "qt_ground_station/ControlOutput")
