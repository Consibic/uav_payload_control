...
(cl:defmethod cl:initialize-instance :after ((m <AttitudeReference>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttitudeReference)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-msg:<AttitudeReference> is deprecated: use qt_ground_station-msg:AttitudeReference instead.")))
...
(cl:defmethod throttle_sp-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:throttle_sp-val is deprecated.  Use qt_ground_station-msg:throttle_sp instead.")
  (throttle_sp m))

(cl:ensure-generic-function 'desired_throttle-val :lambda-list '(m))
(cl:defmethod desired_throttle-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:desired_throttle-val is deprecated.  Use qt_ground_station-msg:desired_throttle instead.")
  (desired_throttle m))

(cl:ensure-generic-function 'desired_attitude-val :lambda-list '(m))
(cl:defmethod desired_attitude-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:desired_attitude-val is deprecated.  Use qt_ground_station-msg:desired_attitude instead.")
  (desired_attitude m))

(cl:ensure-generic-function 'desired_att_q-val :lambda-list '(m))
(cl:defmethod desired_att_q-val ((m <AttitudeReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:desired_att_q-val is deprecated.  Use qt_ground_station-msg:desired_att_q instead.")
  (desired_att_q m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AttitudeReference>)))
  ...
  "qt_ground_station/AttitudeReference")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AttitudeReference)))
  "Returns string type for a message object of type 'AttitudeReference"
  "qt_ground_station/AttitudeReference")
