...
(cl:defmethod cl:initialize-instance :after ((m <Mocap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mocap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ground_station-msg:<Mocap> is deprecated: use qt_ground_station-msg:Mocap instead.")))
...
(cl:defmethod angular_velocity-val ((m <Mocap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:angular_velocity-val is deprecated.  Use qt_ground_station-msg:angular_velocity instead.")
  (angular_velocity m))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <Mocap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ground_station-msg:quaternion-val is deprecated.  Use qt_ground_station-msg:quaternion instead.")
  (quaternion m))
