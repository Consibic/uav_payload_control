...
// (in-package qt_ground_station.srv)
...
class MultiPayloadActionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MultiPayloadActionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MultiPayloadActionRequest
    let len;
    let data = new MultiPayloadActionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MultiPayloadActionRequest(null);
...
class MultiPayloadActionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.status_ok = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MultiPayloadActionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MultiPayloadActionResponse
    let len;
    let data = new MultiPayloadActionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'qt_ground_station/MultiPayloadActionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MultiPayloadActionResponse(null);
...
module.exports = {
  Request: MultiPayloadActionRequest,
  Response: MultiPayloadActionResponse,
  md5sum() { return '901dfe89bb4f4622133561aed17b3eb7'; },
  datatype() { return 'qt_ground_station/MultiPayloadAction'; }
};
