// Generated by gencpp from file qt_ground_station/DroneState.msg
// DO NOT EDIT!


#ifndef QT_GROUND_STATION_MESSAGE_DRONESTATE_H
#define QT_GROUND_STATION_MESSAGE_DRONESTATE_H
...
struct DroneState_
{
  ...
  typedef boost::shared_ptr< ::qt_ground_station::DroneState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::qt_ground_station::DroneState_<ContainerAllocator> const> ConstPtr;

}; // struct DroneState_

typedef ::qt_ground_station::DroneState_<std::allocator<void> > DroneState;

typedef boost::shared_ptr< ::qt_ground_station::DroneState > DroneStatePtr;
typedef boost::shared_ptr< ::qt_ground_station::DroneState const> DroneStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::qt_ground_station::DroneState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::qt_ground_station::DroneState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::qt_ground_station::DroneState_<ContainerAllocator1> & lhs, const ::qt_ground_station::DroneState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::qt_ground_station::DroneState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qt_ground_station::DroneState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qt_ground_station::DroneState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qt_ground_station::DroneState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qt_ground_station::DroneState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qt_ground_station::DroneState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::qt_ground_station::DroneState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::qt_ground_station::DroneState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc76d09f3b60e8a22ULL;
  static const uint64_t static_value2 = 0x4df1768813272926ULL;
};

template<class ContainerAllocator>
struct DataType< ::qt_ground_station::DroneState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::qt_ground_station::DroneState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::qt_ground_station::DroneState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::qt_ground_station::DroneState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::qt_ground_station::DroneState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // QT_GROUND_STATION_MESSAGE_DRONESTATE_H
