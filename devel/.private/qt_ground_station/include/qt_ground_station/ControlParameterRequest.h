// Generated by gencpp from file qt_ground_station/ControlParameterRequest.msg
// DO NOT EDIT!


#ifndef QT_GROUND_STATION_MESSAGE_CONTROLPARAMETERREQUEST_H
#define QT_GROUND_STATION_MESSAGE_CONTROLPARAMETERREQUEST_H
...
struct ControlParameterRequest_
{
  ...
  typedef boost::shared_ptr< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ControlParameterRequest_

typedef ::qt_ground_station::ControlParameterRequest_<std::allocator<void> > ControlParameterRequest;

typedef boost::shared_ptr< ::qt_ground_station::ControlParameterRequest > ControlParameterRequestPtr;
typedef boost::shared_ptr< ::qt_ground_station::ControlParameterRequest const> ControlParameterRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::qt_ground_station::ControlParameterRequest_<ContainerAllocator1> & lhs, const ::qt_ground_station::ControlParameterRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::qt_ground_station::ControlParameterRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xebfb0198b02485c9ULL;
  static const uint64_t static_value2 = 0xa6ec17f0c11eda7aULL;
};

template<class ContainerAllocator>
struct DataType< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::qt_ground_station::ControlParameterRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::qt_ground_station::ControlParameterRequest_<ContainerAllocator>& v)
  {
...
#endif // QT_GROUND_STATION_MESSAGE_CONTROLPARAMETERREQUEST_H
