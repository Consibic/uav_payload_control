...
"""autogenerated by genpy from qt_ground_station/Trajectory.msg. Do not edit."""
import codecs
import sys
...
class Trajectory(genpy.Message):
  _md5sum = "6c2699158086d77a83df8e76c8153e2a"
  _type = "qt_ground_station/Trajectory"
...
float32 roll_ref  ## [rad]"""
  ...
  _slot_types = ['std_msgs/Header','qt_ground_station/TrajectoryPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = qt_ground_station.msg.TrajectoryPoint()
        _v3 = val1.header
        start = end
        end += 4
