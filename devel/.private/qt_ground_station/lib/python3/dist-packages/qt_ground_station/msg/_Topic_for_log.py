...
"""autogenerated by genpy from qt_ground_station/Topic_for_log.msg. Do not edit."""
import codecs
import sys
...
float32[3] Throttle"""
  ...
  _slot_types = ['std_msgs/Header','float32','qt_ground_station/DroneState','qt_ground_station/ControlCommand','qt_ground_station/AttitudeReference','qt_ground_station/ControlOutput']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.Drone_State is None:
        self.Drone_State = qt_ground_station.msg.DroneState()
      if self.Control_Command is None:
        self.Control_Command = qt_ground_station.msg.ControlCommand()
      if self.Attitude_Reference is None:
        self.Attitude_Reference = qt_ground_station.msg.AttitudeReference()
      if self.Control_Output is None:
        self.Control_Output = qt_ground_station.msg.ControlOutput()
    else:
      self.header = std_msgs.msg.Header()
      self.time = 0.
      self.Drone_State = qt_ground_station.msg.DroneState()
