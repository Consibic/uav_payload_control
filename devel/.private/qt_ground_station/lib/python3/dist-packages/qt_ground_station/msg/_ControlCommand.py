...
"""autogenerated by genpy from qt_ground_station/ControlCommand.msg. Do not edit."""
import codecs
import sys
...
class ControlCommand(genpy.Message):
  _md5sum = "5825d4d3402a7fd96de515173f6f5d19"
  _type = "qt_ground_station/ControlCommand"
...
float32 roll_ref  ## [rad]"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint8','qt_ground_station/TrajectoryPoint']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.Reference_State is None:
        self.Reference_State = qt_ground_station.msg.TrajectoryPoint()
    else:
      self.header = std_msgs.msg.Header()
      self.Command_ID = 0
      self.Mode = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f().pack(_x.Reference_State.yaw_ref, _x.Reference_State.pitch_ref, _x.Reference_State.roll_ref))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Reference_State.yaw_ref, _x.Reference_State.pitch_ref, _x.Reference_State.roll_ref,) = _get_struct_3f().unpack(str[start:end])
      return self
